      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Drag handles (⋮⋮) to reorder • Duo groups move as a unit
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-lime-500/10 hover:bg-lime-500/20 text-lime-600 dark:text-lime-400 border border-lime-500/25 text-xs font-bold transition-all cursor-pointer"
            title="Create or manage preset partner groups"
          >
            <Link className="w-3.5 h-3.5" />
            <span>Preset Groups</span>
          </button>
        </div>
      </div>
      ...
      {queue.length > 0 && (
        <div className="relative w-full">
          ...
          <input
            ...
            placeholder="Search player or group in queue..."
          ...
          {filteredQueueWithIndex.map(({ player, originalIndex }) => {
            ...
            return (
              <div
                ...
                style={group ? { borderLeftColor: group.color, borderLeftWidth: '4px' } : undefined}
              >
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  {group && (
                    <button
                      ...
                      className="p-1.5 text-slate-400 hover:text-amber-500 hover:bg-amber-50 dark:hover:bg-amber-950/40 rounded-xl transition-colors"
